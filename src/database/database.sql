...
create table orders(product_id int primary key not null, company text null, phone text not null, price int not null, config text not null);
...
insert into products(product_id,company,phone,price,config) values(10003,'samsung','Galaxy-M40',20000,'RAM-4GB STORAGE-64GB');
